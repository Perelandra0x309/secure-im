...
<ul>
  ...
  <ul>
    <li>{% include generate_app_link.html app_name="threema" %}- P2P, based in Switzerland [No PFS or ephemeral messages]</li>
  ...
  <ul>
    ...
    <li>{% include generate_app_link.html app_name="ricochet" %}- P2P, uses Tor [Desktop only, text only, no contact verification]</li>
...
<table>
  ...
  <tr>
    <td>{% include generate_app_link.html app_name="ricochet" %}</td>
    <td>0</td><td>0</td><td>1</td><td>1</td><td>1</td><td>0</td><td>0</td><td>1 (No central servers)</td><td>4</td>
  </tr>
